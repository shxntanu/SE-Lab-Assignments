...
BT rax,63                           ; Bit test the MSB of the qword
jc next                             ; If byte is set i.e. 1 then increment negative counter

inc byte[pos]                       ; Else increment positive counter
add rsi,8                           ; Go to next address in array
dec byte[count]
JNZ up
